...
{
    /**
     * Looks for a remote object with the given name at port 3000 at the given host and returns it.
     *
    ...
    throws InvalidName, CannotProceed,
    ...
    throws InvalidName, AdapterInactive, WrongPolicy, ServantNotActive,
    org.omg.CosNaming.NamingContextPackage.InvalidName, NotFound, CannotProceed
    {
        ...
        NamingContextExt naming = NamingContextExtHelper.narrow(orb.
                                                                resolve_initial_references("NameService")); // (NamingContextExt)
